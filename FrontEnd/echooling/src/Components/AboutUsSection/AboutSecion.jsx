  ...
  return (
    <div className={Styles.MainContainer}>
      <div className={Styles.LeftSideContainer}>
        ...
        <img className={Styles.bakcgoundItem1} src={BackgroundImage1} alt="" />
        <img className={Styles.bakcgoundItem2} src={BackgroundImage4} alt="" />
        <img className={Styles.bakcgoundItem3} src={BackgroundImage2} alt="" />
        <img className={Styles.bakcgoundItem4} src={BackgroundImage3} alt="" />
      </div>
