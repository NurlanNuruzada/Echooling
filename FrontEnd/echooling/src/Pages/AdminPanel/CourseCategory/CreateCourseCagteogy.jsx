...
import Styles from './CreateCourseCagteogy.module.css';
...
import { DeleteCourseCategory, getAllCourseategories, postCourseCategory } from '../../../Services/CategoryService';
...
export default function CreateCourseCagteogy() {
    ...
    const { mutate } = useMutation(
        (formData) => postCourseCategory(formData),
        {
            onSuccess: (resp) => {
                setSentSuccess(true);
    ...
    const { mutate: Delete } = useMutation(
        (GuId) => DeleteCourseCategory(GuId),
        {
            onSuccess: (resp) => {
                setSentSuccess(true);
                queryClient.invalidateQueries("sliders");
