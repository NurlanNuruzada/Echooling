...
namespace Echooling.Persistance.Migrations
{
    ...
    [Migration("20230905183603_addedStaffAndEvent")]
    partial class addedStaffAndEvent
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ecooling.Domain.Entites.AppUser", b =>
                {
                    b.HasOne("Ecooling.Domain.Entites.events", null)
                        .WithMany("Atendances")
                        .HasForeignKey("eventsGuId");
                });
