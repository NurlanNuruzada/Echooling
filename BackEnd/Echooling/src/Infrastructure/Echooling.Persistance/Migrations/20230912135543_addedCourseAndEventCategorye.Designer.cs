...
namespace Echooling.Persistance.Migrations
{
    ...
    [Migration("20230912135543_addedCourseAndEventCategorye")]
    partial class addedCourseAndEventCategorye
    {
            ...
            modelBuilder.Entity("Ecooling.Domain.Entites.events", b =>
                {
                    ...
                    b.Property<Guid>("EventCategoryiesGuId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("EventCategoryiesGuId");
            ...
            modelBuilder.Entity("Ecooling.Domain.Entites.events", b =>
                {
                    b.HasOne("Ecooling.Domain.Entites.EventCategoryies", "EventCategoryies")
                        .WithMany("Events")
                        .HasForeignKey("EventCategoryiesGuId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
